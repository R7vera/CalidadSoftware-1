        ...
        <div class="flex-1 p-8">
            ...
            <div class="mt-8 bg-white p-6 rounded-lg shadow">
                ...
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-lg font-bold">Lista de Proveedores</h2>
                ...
                <table class="min-w-full border-collapse border border-gray-300">
                    <thead>
                        <tr class="bg-gray-200">
                            ...
                            <th class="border border-gray-300 px-4 py-2">Nro Contacto</th>
                            <th class="border border-gray-300 px-4 py-2">Nro Documento</th>
                        ...
                        <?php if (!empty($suppliers)): ?>
                            ...
                            <?php foreach ($suppliers as $supplier): ?>
                                <tr>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($supplier['persona']); ?></td>
                                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($supplier['proveedor_contacto']); ?></td>
                                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($supplier['proveedor_numcontacto']); ?></td>
                                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($supplier['persona_nrodocumento']); ?></td>
                                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($supplier['persona_tipodocumento']); ?></td>
                                    <td class="border border-gray-300 px-4 py-2 text-center">
                                        <?php if ($supplier['proveedor_estatus'] == 'ACTIVO'): ?>
                                            <span class="text-green-500 font-bold"><?php echo htmlspecialchars($supplier['proveedor_estatus']); ?></span>
                                        <?php else: ?>
                                            <span class="text-red-500 font-bold"><?php echo htmlspecialchars($supplier['proveedor_estatus']); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="border border-gray-300 px-4 py-2 text-center">
                                        <a href="proveedores?id=<?php echo htmlspecialchars($supplier['proveedor_id']); ?>&action=ACTIVO" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded">
                                            <i class="fas fa-check"></i>
                                        </a>
                                        <a href="proveedores?id=<?php echo htmlspecialchars($supplier['proveedor_id']); ?>&action=INACTIVO" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded">
            ...
            <div id="myModal" class="modal hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
                <div class="bg-white p-6 rounded-lg shadow-lg w-1/2 relative"> <!-- Ancho ajustado a la mitad de la pantalla -->
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-lg font-bold">Registrar Proveedor</h2>
                    ...
                    <form id="supplierForm" action="proveedores" method="POST">
                        <!-- Nombre -->
                        <div class="mb-4">
                            <label for="razon_social" class="block text-gray-700 font-bold mb-2">Razon Social:</label>
                            <input type="text" id="razon_social" name="razon_social" class="w-full px-4 py-2 border border-gray-300 rounded" placeholder="Ingrese la razon social" required>
                        </div>
                        ...
                        <div class="mb-4 grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="nombre_contacto" name="nombre_contacto" class="w-full px-4 py-2 border border-gray-300 rounded" placeholder="Ingrese nombre de contacto" required>
                            </div>
                            <div>
                                <label for="nro_contacto" class="block text-gray-700 font-bold mb-2">Nro de contacto:</label>
                                <input type="text" id="nro_contacto" name="nro_contacto" class="w-full px-4 py-2 border border-gray-300 rounded" placeholder="Ingrese numero de contacto" required>
                            </div>
                        </div>
                        <!-- Nombre -->
                        <div class="mb-4">
